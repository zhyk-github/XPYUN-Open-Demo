...
func PrintComplexReceipt() {
	...
	printContent = printContent + "name" + util.StrRepeat(" ", 16) + "count" + util.StrRepeat(" ", 2) + "price" + util.StrRepeat(" ", 2) + "<BR>"
	...
	printContent = printContent + "<BR>"
	printContent = printContent + "<L>" + "address：" + "Broadway, New York City" + "<BR>" +
		"phone：" + "1363*****88" + "<BR>" + "orderTime：" + "2020-9-9 15:07:57" + "<BR>" + "remarks：" + "Less spicy" + "<BR>"
