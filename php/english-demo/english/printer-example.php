...
include_once 'formatter/note-formatter.php';
 ...
 * only the last alignment element C is valid
 */
function printFontAlignVoiceSupport() {
...
function printComplexReceipt() {
    ...
    $printContent = $printContent.formatPrintOrderItem("Stewed Ribs", 2, 9.99);
    $printContent = $printContent.formatPrintOrderItem("Boiled Fish", 1, 108.0);
    $printContent = $printContent.formatPrintOrderItem("Braised Codfish with Mushrooms", 1, 99.9);
    $printContent = $printContent.formatPrintOrderItem("Braised Squid", 5, 19.99);
    $printContent = $printContent.str_repeat("-", 32)."<BR>";
