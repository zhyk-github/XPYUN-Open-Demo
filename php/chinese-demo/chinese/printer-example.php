...
function printComplexReceipt() {
    ...
    $printContent = $printContent.formatPrintOrderItem("可乐鸡翅", 2, 9.99);
    $printContent = $printContent.formatPrintOrderItem("水煮鱼特辣", 1, 108.0);
    $printContent = $printContent.formatPrintOrderItem("豪华版超级无敌龙虾炒饭", 1, 99.9);
    $printContent = $printContent.formatPrintOrderItem("炭烤鳕鱼", 5, 19.99);
    $printContent = $printContent.str_repeat("-", 32)."<BR>";
